export const POSTS = [
  {
    ...
    updatedAt: null,
    excerpt:
      "Lessons learned from architecting React frontends that serve thousands of users. From component composition to state management patterns that scale.",
  ...
  },
  {
    ...
    updatedAt: null,
    excerpt:
      "How to implement live chat, notifications, and collaborative features using WebSocket events in a production Node.js backend.",
  ...
  },
  {
    ...
    updatedAt: null,
    excerpt:
      "A practical guide to setting up GitHub Actions for automated testing, building, and deploying to AWS EC2/RDS without over-engineering.",
    tags: ["DevOps", "AWS"],
    readTime: "5 min read",
    content: `
...
export function readingMinutes(html, wpm = 220) {
  return Math.max(1, Math.round(wordCount(html) / wpm));
}
